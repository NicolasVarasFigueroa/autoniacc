      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          ...
          <Paragraph className="mt-8">
            Con Autoniac, puedes eliminar tareas repetitivas, mejorar tus procesos y tomar decisiones más rápidas y precisas gracias a la automatización inteligente.

Nos conectamos fácilmente a tus herramientas actuales para ayudarte a ahorrar tiempo, reducir errores y enfocarte en lo que realmente importa: hacer crecer tu negocio.
          </Paragraph>
            ...
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              ...
              >
                ...
                <Button className="min-w-max text-white">
                  <span className="relative z-[5]">Más Info</span>
                </Button>
              </form>
            </div>
          </div>
        ...
        <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-non lg:mx-0 mx-auto max-w-3xl">
          <img
            src="../public/assets/personaa.png"
            alt="Hero image"
            width={2350}
            height={2359}
